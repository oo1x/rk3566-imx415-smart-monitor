...
// static const struct imx415_mode imx415_supported_modes[] = {
//     {
//         .width = 3864,
//         .height = 2192,
//         .fps = 15,
...
// #define to_myimx415(sd) container_of(sd, struct myimx415, subdev)

// static int myimx415_write_reg(struct i2c_client *client,
...
// static int myimx415_write_array(struct i2c_client *client,
...
//             usleep_range(regs->val * 1000, regs->val * 1000 + 500);
//         else {
//             ret = myimx415_write_reg(client, regs->addr,
//                                      IMX415_REG_VALUE_08BIT, regs->val);
//             if (ret)
//                 return ret;
//         }
//         regs++;
...
// static int myimx415_read_reg(struct i2c_client *client,
...
// static int myimx415_enum_mbus_code(struct v4l2_subdev *sd,
//                                    struct v4l2_subdev_pad_config *cfg,
//                                    struct v4l2_subdev_mbus_code_enum *code)
// {
//     if (code->index >= ARRAY_SIZE(imx415_supported_modes))
//         return -EINVAL;
//     code->code = imx415_supported_modes[code->index].bus_fmt;
//     return 0;
// }

// static int myimx415_get_fmt(struct v4l2_subdev *sd,
//                             struct v4l2_subdev_pad_config *cfg,
//                             struct v4l2_subdev_format *fmt)
// {
//     struct myimx415 *imx415 = to_myimx415(sd);

//     fmt->format.width  = imx415->cur_mode->width;
//     fmt->format.height = imx415->cur_mode->height;
//     fmt->format.code   = imx415->cur_mode->bus_fmt;
//     fmt->format.field  = V4L2_FIELD_NONE;
//     return 0;
// }

// static int myimx415_set_fmt(struct v4l2_subdev *sd,
//                             struct v4l2_subdev_pad_config *cfg,
//                             struct v4l2_subdev_format *fmt)
// {
//     struct myimx415 *imx415 = to_myimx415(sd);
...
//         *v4l2_subdev_get_try_format(sd, cfg, 0) = fmt->format;

//     return 0;
// }

// static int myimx415_s_stream(struct v4l2_subdev *sd, int on)
// {
//     struct myimx415 *imx415 = to_myimx415(sd);
...
//             goto unlock;
//         }
//         ret = myimx415_write_array(client, imx415->cur_mode->reg_list);
//         if (ret) {
...
//             goto unlock;
//         }
//         ret = myimx415_write_reg(client, IMX415_REG_CTRL_MODE,
//                                  IMX415_REG_VALUE_08BIT, IMX415_MODE_STREAMING);
//         if (ret)
//             pm_runtime_put(&client->dev);
//     } else {
//         myimx415_write_reg(client, IMX415_REG_CTRL_MODE,
...
// static int myimx415_g_mbus_config(struct v4l2_subdev *sd,
...
// static int myimx415_set_ctrl(struct v4l2_ctrl *ctrl)
// {
//     struct myimx415 *imx415 = container_of(ctrl->handler,
//                                            struct myimx415, ctrl_handler);
//     struct i2c_client *client = imx415->client;
//     u32 shr0;
//     int ret = 0;
...
//         ret  = myimx415_write_reg(client, IMX415_LF_EXPO_REG_L,
//                                   IMX415_REG_VALUE_08BIT, shr0 & 0xFF);
//         ret |= myimx415_write_reg(client, IMX415_LF_EXPO_REG_M,
//                                   IMX415_REG_VALUE_08BIT, (shr0 >> 8) & 0xFF);
//         ret |= myimx415_write_reg(client, IMX415_LF_EXPO_REG_H,
//                                   IMX415_REG_VALUE_08BIT, (shr0 >> 16) & 0xFF);
//         break;
//     case V4L2_CID_ANALOGUE_GAIN:
//         ret  = myimx415_write_reg(client, IMX415_LF_GAIN_REG_L,
//                                   IMX415_REG_VALUE_08BIT, ctrl->val & 0xFF);
//         ret |= myimx415_write_reg(client, IMX415_LF_GAIN_REG_H,
//                                   IMX415_REG_VALUE_08BIT, (ctrl->val >> 8) & 0xFF);
//         break;
//     default:
//         break;
//     }
...
// static const struct v4l2_ctrl_ops myimx415_ctrl_ops = {
//     .s_ctrl = myimx415_set_ctrl,
// };

// static int myimx415_initialize_controls(struct myimx415 *imx415)
// {
...
//     pixel_rate = (u64)mode->mipi_freq / 10 * 2 * 2;
//     imx415->pixel_rate = v4l2_ctrl_new_std(handler, NULL, V4L2_CID_PIXEL_RATE,
...
//     imx415->vblank = v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops,
//                                        V4L2_CID_VBLANK, vblank_def,
//                                        0x7fff - mode->height, 1, vblank_def);
//     imx415->cur_vts = mode->vts_def;

//     imx415->exposure = v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops,
//                                          V4L2_CID_EXPOSURE, IMX415_EXPOSURE_MIN,
//                                          mode->vts_def - 8, IMX415_EXPOSURE_STEP,
//                                          mode->exp_def);

//     imx415->anal_gain = v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops,
//                                           V4L2_CID_ANALOGUE_GAIN,
//                                           IMX415_GAIN_MIN, IMX415_GAIN_MAX,
//                                           IMX415_GAIN_STEP, IMX415_GAIN_DEFAULT);
...
// static const struct v4l2_subdev_video_ops myimx415_video_ops = {
//     .s_stream      = myimx415_s_stream,
//     .g_mbus_config = myimx415_g_mbus_config,
// };

// static int myimx415_get_selection(struct v4l2_subdev *sd,
//                                   struct v4l2_subdev_pad_config *cfg,
...
// static const struct v4l2_subdev_pad_ops myimx415_pad_ops = {
//     .enum_mbus_code = myimx415_enum_mbus_code,
//     .get_fmt        = myimx415_get_fmt,
//     .set_fmt        = myimx415_set_fmt,
//     .get_selection  = myimx415_get_selection,
// };

// static const struct v4l2_subdev_ops myimx415_subdev_ops = {
//     .video = &myimx415_video_ops,
//     .pad   = &myimx415_pad_ops,
// };

// static int myimx415_check_chip_id(struct myimx415 *imx415)
// {
//     struct i2c_client *client = imx415->client;
//     u32 id = 0;
//     int ret;

//     ret = myimx415_read_reg(client, IMX415_REG_CHIP_ID,
...
//         return -ENODEV;
//     }
//     dev_info(&client->dev, "Detected IMX415, chip_id=0x%02x\n", id);
//     return 0;
// }

// static int myimx415_power_on(struct myimx415 *imx415)
// {
...
//     ret = clk_set_rate(imx415->xvclk, 37125000);
//     if (ret < 0)
...
// static void myimx415_power_off(struct myimx415 *imx415)
// {
//     if (!IS_ERR(imx415->reset_gpio))
//         gpiod_direction_output(imx415->reset_gpio, 1);
//     clk_disable_unprepare(imx415->xvclk);
...
// static int __maybe_unused myimx415_runtime_resume(struct device *dev)
// {
//     struct i2c_client *client = to_i2c_client(dev);
//     struct v4l2_subdev *sd = i2c_get_clientdata(client);
//     struct myimx415 *imx415 = to_myimx415(sd);

//     return myimx415_power_on(imx415);
// }

// static int __maybe_unused myimx415_runtime_suspend(struct device *dev)
// {
//     struct i2c_client *client = to_i2c_client(dev);
//     struct v4l2_subdev *sd = i2c_get_clientdata(client);
//     struct myimx415 *imx415 = to_myimx415(sd);

//     myimx415_power_off(imx415);
//     return 0;
// }

// static const struct dev_pm_ops myimx415_pm_ops = {
//     SET_RUNTIME_PM_OPS(myimx415_runtime_suspend,
//                        myimx415_runtime_resume,
//                        NULL)
// };

// static int myimx415_probe(struct i2c_client *client,
//                           const struct i2c_device_id *id)
// {
//     struct device *dev = &client->dev;
//     struct myimx415 *imx415;
//     unsigned int i;
//     int ret;

//     dev_info(dev, "myimx415 probe start\n");
...
//     ret = devm_regulator_bulk_get(dev, IMX415_NUM_SUPPLIES, imx415->supplies);
//     if (ret) {
...
//     imx415->cur_mode = &imx415_supported_modes[0];

//     v4l2_i2c_subdev_init(&imx415->subdev, client, &myimx415_subdev_ops);
//     imx415->subdev.flags |= V4L2_SUBDEV_FL_HAS_DEVNODE | V4L2_SUBDEV_FL_HAS_EVENTS;

//     ret = myimx415_initialize_controls(imx415);
//     if (ret)
//         goto err_destroy_mutex;

//     ret = myimx415_power_on(imx415);
//     if (ret) {
//         dev_err(dev, "Failed to power on\n");
//         goto err_free_handler;
//     }

//     ret = myimx415_check_chip_id(imx415);
//     if (ret)
//         goto err_power_off;

//     imx415->pad.flags = MEDIA_PAD_FL_SOURCE;
//     imx415->subdev.entity.function = MEDIA_ENT_F_CAM_SENSOR;
//     ret = media_entity_pads_init(&imx415->subdev.entity, 1, &imx415->pad);
//     if (ret < 0)
// 	{
// 		goto err_power_off;
// 	}

// 	snprintf(imx415->subdev.name, sizeof(imx415->subdev.name),
//          "m00_b_imx415 %s", dev_name(&client->dev));

//     ret = v4l2_async_register_subdev_sensor_common(&imx415->subdev);
//     if (ret) {
//         dev_err(dev, "v4l2 async register subdev failed\n");
//         goto err_clean_entity;
//     }
//     dev_info(dev, "v4l2 async register subdev success\n");
...
//     dev_info(dev, "myimx415 probe success!\n");
//     return 0;

// err_clean_entity:
//     media_entity_cleanup(&imx415->subdev.entity);
// err_power_off:
//     myimx415_power_off(imx415);
// err_free_handler:
...
// static int myimx415_remove(struct i2c_client *client)
// {
//     struct v4l2_subdev *sd = i2c_get_clientdata(client);
//     struct myimx415 *imx415 = to_myimx415(sd);

//     v4l2_ctrl_handler_free(&imx415->ctrl_handler);
//     v4l2_async_unregister_subdev(&imx415->subdev);
//     media_entity_cleanup(&imx415->subdev.entity);
//     pm_runtime_disable(&client->dev);
//     pm_runtime_set_suspended(&client->dev);
//     dev_info(&client->dev, "myimx415 removed\n");
//     return 0;
// }

// static const struct of_device_id myimx415_of_match[] = {
//     { .compatible = "sony,imx415" },
//     { }
// };
// MODULE_DEVICE_TABLE(of, myimx415_of_match);

// static const struct i2c_device_id myimx415_id[] = {
//     { "mydriver-imx415", 0 },
//     { }
// };
// MODULE_DEVICE_TABLE(i2c, myimx415_id);

// static struct i2c_driver myimx415_driver = {
//     .driver = {
//         .name           = DRIVER_NAME,
//         .pm             = &myimx415_pm_ops,
//         .of_match_table = myimx415_of_match,
//     },
//     .probe    = myimx415_probe,
//     .remove   = myimx415_remove,
//     .id_table = myimx415_id,
// };

// module_i2c_driver(myimx415_driver);

// MODULE_LICENSE("GPL");
// MODULE_AUTHOR("oo1");
// MODULE_DESCRIPTION("My IMX415 camera driver for learning");
...
// static const struct regval imx415_linear_10bit_3864x2192_891M_regs_2lane[] = {
//     {0x3008, 0x7F}, {0x3031, 0x00}, {0x3032, 0x00}, {0x300A, 0x5B},
//     {0x3028, 0x98}, {0x3029, 0x08}, {0x3033, 0x05}, {0x3050, 0x79},
//     {0x3051, 0x07}, {0x3090, 0x14}, {0x30C1, 0x00}, {0x3116, 0x24},
//     {0x3118, 0xC0}, {0x311A, 0xE0}, {0x311E, 0x24}, {0x32D4, 0x21},
//     {0x32EC, 0xA1}, {0x344C, 0x2B}, {0x344D, 0x01}, {0x344E, 0xED},
//     {0x344F, 0x01}, {0x3450, 0xF6}, {0x3451, 0x02}, {0x3452, 0x7F},
//     {0x3453, 0x03}, {0x358A, 0x04}, {0x35A1, 0x02}, {0x35EC, 0x27},
//     {0x35EE, 0x8D}, {0x35F0, 0x8D}, {0x35F2, 0x29}, {0x36BC, 0x0C},
//     {0x36CC, 0x53}, {0x36CD, 0x00}, {0x36CE, 0x3C}, {0x36D0, 0x8C},
//     {0x36D1, 0x00}, {0x36D2, 0x71}, {0x36D4, 0x3C}, {0x36D6, 0x53},
//     {0x36D7, 0x00}, {0x36D8, 0x71}, {0x36DA, 0x8C}, {0x36DB, 0x00},
//     {0x3720, 0x00}, {0x3724, 0x02}, {0x3726, 0x02}, {0x3732, 0x02},
//     {0x3734, 0x03}, {0x3736, 0x03}, {0x3742, 0x03}, {0x3862, 0xE0},
//     {0x38CC, 0x30}, {0x38CD, 0x2F}, {0x395C, 0x0C}, {0x39A4, 0x07},
...
//     {0x3B00, 0x2E}, {0x3B06, 0x29}, {0x3B98, 0x25}, {0x3B99, 0x21},
...
//     {0x3BA9, 0x1A}, {0x3BAC, 0xED}, {0x3BAD, 0x01}, {0x3BAE, 0xF6},
//     {0x3BAF, 0x02}, {0x3BB0, 0xA2}, {0x3BB1, 0x03}, {0x3BB2, 0xE0},
//     {0x3BB3, 0x03}, {0x3BB4, 0xE0}, {0x3BB5, 0x03}, {0x3BB6, 0xE0},
//     {0x3BB7, 0x03}, {0x3BB8, 0xE0}, {0x3BBA, 0xE0}, {0x3BBC, 0xDA},
//     {0x3BBE, 0x88}, {0x3BC0, 0x44}, {0x3BC2, 0x7B}, {0x3BC4, 0xA2},
//     {0x3BC8, 0xBD}, {0x3BCA, 0xBD}, {0x4001, 0x01}, {0x4004, 0x48},
//     {0x4005, 0x09}, {0x400C, 0x00}, {0x4018, 0x7F}, {0x401A, 0x37},
//     {0x401C, 0x37}, {0x401E, 0xF7}, {0x401F, 0x00}, {0x4020, 0x3F},
//     {0x4022, 0x6F}, {0x4024, 0x3F}, {0x4026, 0x5F}, {0x4028, 0x2F},
//     {0x4074, 0x01}, {0x3002, 0x00},
//     {REG_DELAY, 0x1E},
//     {REG_NULL,  0x00},
// };

// static __maybe_unused const struct regval imx415_linear_10bit_1920x1080_891M_regs_2lane[] = {
// 	{0x3008, 0x7f}, {0x300A, 0x5b}, {0x3034, 0x05},
// 	// {0x301C, 0x04},
// 	{0x3020, 0x01},	{0x3021, 0x01},	{0x3022, 0x01},	{0x3024, 0xca},
// 	{0x3025, 0x08},	{0x3028, 0x26},	{0x3029, 0x02},	{0x3031, 0x00},
// 	{0x3032, 0x00},	{0x3033, 0x05},	{0x3050, 0xC4},	{0x3090, 0x14},
// 	{0x30C1, 0x00},	{0x30D9, 0x02},	{0x30DA, 0x01},	{0x3116, 0x24},
// 	{0x3118, 0xC0},	{0x311A, 0xE0},	{0x311E, 0x24},	{0x32D4, 0x21},
// 	{0x32EC, 0xA1},	{0x344C, 0x2B},	{0x344D, 0x01},
// 	{0x344E, 0xED},	{0x344F, 0x01},	{0x3450, 0xF6},	{0x3451, 0x02},
// 	{0x3452, 0x7F},	{0x3453, 0x03},	{0x358A, 0x04},	{0x35A1, 0x02},
// 	{0x35EC, 0x27},	{0x35EE, 0x8D},	{0x35F0, 0x8D},	{0x35F2, 0x29},
// 	{0x36BC, 0x0C},	{0x36CC, 0x53},	{0x36CD, 0x00},	{0x36CE, 0x3C},
// 	{0x36D0, 0x8C},	{0x36D1, 0x00},	{0x36D2, 0x71},	{0x36D4, 0x3C},
// 	{0x36D6, 0x53},	{0x36D7, 0x00},	{0x36D8, 0x71},	{0x36DA, 0x8C},
// 	{0x36DB, 0x00},	{0x3701, 0x00},	{0x3720, 0x00},	{0x3724, 0x02},
// 	{0x3726, 0x02},
// 	{0x3732, 0x02},
// 	{0x3734, 0x03},
// 	{0x3736, 0x03},
...
// static const char * const imx415_supply_names[] = { "dvdd", "dovdd", "avdd" };
// #define IMX415_NUM_SUPPLIES ARRAY_SIZE(imx415_supply_names)
...
// static int myimx415_write_reg(struct i2c_client *client, u16 reg, u32 len, u32 val)
// {
//     u32 buf_i, val_i;
//     u8 buf[6];
//     u8 *val_p;
...
//     val_p = (u8 *)&val_be;
//     buf_i = 2; val_i = 4 - len;
//     while (val_i < 4) buf[buf_i++] = val_p[val_i++];
//     if (i2c_master_send(client, buf, len + 2) != len + 2) return -EIO;
//     return 0;
// }

// static int myimx415_write_array(struct i2c_client *client, const struct regval *regs)
// {
//     int ret = 0;
...
//             usleep_range(regs->val * 1000, regs->val * 1000 + 500);
//         else {
//             ret = myimx415_write_reg(client, regs->addr, IMX415_REG_VALUE_08BIT, regs->val);
//             if (ret) return ret;
//         }
//         regs++;
//     }
...
// static int myimx415_read_reg(struct i2c_client *client, u16 reg, unsigned int len, u32 *val)
// {
//     struct i2c_msg msgs[2];
//     u8 *data_be_p;
//     __be32 data_be = 0;
...
//     if (len > 4 || !len) return -EINVAL;
//     data_be_p = (u8 *)&data_be;
//     msgs[0].addr = client->addr; msgs[0].flags = 0;
//     msgs[0].len = 2; msgs[0].buf = (u8 *)&reg_addr_be;
//     msgs[1].addr = client->addr; msgs[1].flags = I2C_M_RD;
//     msgs[1].len = len; msgs[1].buf = &data_be_p[4 - len];
//     ret = i2c_transfer(client->adapter, msgs, ARRAY_SIZE(msgs));
...
// static int myimx415_enum_frame_sizes(struct v4l2_subdev *sd,
//                                      struct v4l2_subdev_pad_config *cfg,
...
// static int myimx415_enum_frame_interval(struct v4l2_subdev *sd,
//                                         struct v4l2_subdev_pad_config *cfg,
//                                         struct v4l2_subdev_frame_interval_enum *fie)
// {
//     if(fie->index >= ARRAY_SIZE(supported_modes)) return -EINVAL;
...
// static int myimx415_g_frame_interval(struct v4l2_subdev *sd,
...
//             supported_modes[i].bus_fmt == fmt->format.code) {
//             mode = &supported_modes[i];
//             break;
//         }
//     }
//     /* 精确匹配失败则fallback到默认mode */
//     if (!mode)
...
//                                  (u64)link_freq_menu_items[mode->mipi_freq_idx]
//                                  / 10 * 2 * IMX415_2LANES);
//     }
...
//                                    struct v4l2_subdev_mbus_code_enum *code)
// {
//     if (code->index >= ARRAY_SIZE(supported_modes)) return -EINVAL;
...
//         {
//             sel->r.left = CROP_START(3864,3840);
//             sel->r.width = 3840;
//             sel->r.top = CROP_START(2192, 2160);
//             sel->r.height = 2160;
//         }
//         else if(imx415->cur_mode->width == 1944)
//         {
//             sel->r.left = CROP_START(1944, 1920);
//             sel->r.width = 1920;
//             sel->r.top = CROP_START(1096, 1080);
//             sel->r.height = 1080;
//         }
//         else
//         {
...
//         ret = myimx415_write_array(client, imx415->cur_mode->reg_list);
//         if (ret) {
//             dev_err(&client->dev, "write reg array failed: %d\n", ret);
//             pm_runtime_put(&client->dev);
//             goto unlock;
//         }
...
//         ret = __v4l2_ctrl_handler_setup(&imx415->ctrl_handler);
//         if (ret) {
//             dev_err(&client->dev, "ctrl handler setup failed: %d\n", ret);
//             /* sensor已经通过write_array开始工作，需要先让它回到standby */
//             myimx415_write_reg(client, IMX415_REG_CTRL_MODE,
//                                IMX415_REG_VALUE_08BIT, IMX415_MODE_SW_STANDBY);
//             pm_runtime_put(&client->dev);
//             goto unlock;
...
//                                  IMX415_REG_VALUE_08BIT, IMX415_MODE_STREAMING);
//         if (ret) {
//             dev_err(&client->dev, "start streaming failed: %d\n", ret);
//             myimx415_write_reg(client, IMX415_REG_CTRL_MODE,
//                                IMX415_REG_VALUE_08BIT, IMX415_MODE_SW_STANDBY);
//             pm_runtime_put(&client->dev);
//             goto unlock;
...
//     /* vblank变化时，在get_if_in_use之前先更新exposure范围
//      * 因为这个modify_range不需要设备active，只是更新ctrl元数据 */
...
//         vts = ctrl->val + imx415->cur_mode->height;
//         imx415->cur_vts = vts;
//         ret  = myimx415_write_reg(client, IMX415_VTS_REG_L,
//                                   IMX415_REG_VALUE_08BIT, vts & 0xFF);
//         ret |= myimx415_write_reg(client, IMX415_VTS_REG_M,
//                                   IMX415_REG_VALUE_08BIT, (vts >> 8) & 0xFF);
//         ret |= myimx415_write_reg(client, IMX415_VTS_REG_H,
//                                   IMX415_REG_VALUE_08BIT, (vts >> 16) & 0xFF);
//         break;

//     case V4L2_CID_HFLIP:
//         ret = myimx415_read_reg(client, IMX415_FLIP_REG,
...
//         else
//             val &= ~IMX415_MIRROR_BIT_MASK;
//         ret = myimx415_write_reg(client, IMX415_FLIP_REG,
//                                  IMX415_REG_VALUE_08BIT, val);
//         break;
...
//     default:
//         dev_warn(&client->dev, "%s: unhandled ctrl id 0x%x\n",
//                  __func__, ctrl->id);
//         break;
//     }
...
// static const struct v4l2_ctrl_ops myimx415_ctrl_ops = { .s_ctrl = myimx415_set_ctrl };
...
//     ret = v4l2_ctrl_handler_init(handler, 10); /* 8→10，多了hflip/vflip */
//     if (ret) return ret;
...
//     pixel_rate = (u64)link_freq_menu_items[mode->mipi_freq_idx] / 10 * 2 * IMX415_2LANES;
//     max_pixel_rate = (u64)link_freq_menu_items[ARRAY_SIZE(link_freq_menu_items) - 1]
//                      / 10 * 2 * IMX415_2LANES;
...
//     h_blank = mode->hts_def - mode->width;
//     imx415->hblank = v4l2_ctrl_new_std(handler, NULL,
//                                        V4L2_CID_HBLANK,
//                                        h_blank, h_blank, 1, h_blank);
//     if (imx415->hblank)
//         imx415->hblank->flags |= V4L2_CTRL_FLAG_READ_ONLY;
...
//     v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops,
...
//     .s_stream      = myimx415_s_stream,
//     .g_mbus_config = myimx415_g_mbus_config,
//     .g_frame_interval = myimx415_g_frame_interval,
// };
...
//     .set_fmt        = myimx415_set_fmt,
//     .get_selection  = myimx415_get_selection,
//     .enum_frame_interval = myimx415_enum_frame_interval,
//     .enum_frame_size = myimx415_enum_frame_sizes,
// };
...
// static const struct dev_pm_ops myimx415_pm_ops = {
//     SET_RUNTIME_PM_OPS(myimx415_runtime_suspend, myimx415_runtime_resume, NULL)
// };

// static int myimx415_probe(struct i2c_client *client, const struct i2c_device_id *id)
// {
//     struct device *dev = &client->dev;
//     struct myimx415 *imx415;
//     unsigned int i;
...
//     imx415 = devm_kzalloc(dev, sizeof(*imx415), GFP_KERNEL);
//     if (!imx415) return -ENOMEM;
//     imx415->client = client;

//     imx415->xvclk = devm_clk_get(dev, "xvclk");
//     if (IS_ERR(imx415->xvclk)) { dev_err(dev, "Failed to get xvclk\n"); return -EINVAL; }

//     imx415->reset_gpio = devm_gpiod_get(dev, "reset", GPIOD_ASIS);
//     if (IS_ERR(imx415->reset_gpio)) dev_warn(dev, "Failed to get reset-gpios\n");

//     imx415->power_gpio = devm_gpiod_get(dev, "power", GPIOD_ASIS);
//     if (IS_ERR(imx415->power_gpio)) dev_warn(dev, "Failed to get power-gpios\n");

//     for (i = 0; i < IMX415_NUM_SUPPLIES; i++)
//         imx415->supplies[i].supply = imx415_supply_names[i];
//     ret = devm_regulator_bulk_get(dev, IMX415_NUM_SUPPLIES, imx415->supplies);
//     if (ret) { dev_err(dev, "Failed to get regulators\n"); return ret; }
...
//     ret = myimx415_power_on(imx415);
//     if (ret) { dev_err(dev, "Failed to power on\n"); goto err_free_handler; }

//     ret = myimx415_read_reg(client, IMX415_REG_CHIP_ID, IMX415_REG_VALUE_08BIT, &val);
//     if (ret || val != CHIP_ID) {
//         dev_err(dev, "chip id check failed: 0x%02x\n", val);
//         ret = -ENODEV;
//         goto err_power_off;
//     }
//     dev_info(dev, "Detected IMX415, chip_id=0x%02x\n", val);
...
//     ret = v4l2_async_register_subdev_sensor_common(&imx415->subdev);
//     if (ret) { dev_err(dev, "v4l2 async register subdev failed\n"); goto err_clean_entity; }
...
// #include <linux/pm_runtime.h>
// #include <linux/regulator/consumer.h>
// #include <linux/rk-camera-module.h>          /* 新增：rkaiq模块信息接口 */
// #include <media/v4l2-async.h>
// #include <media/v4l2-ctrls.h>
// #include <media/v4l2-subdev.h>
// #include <media/media-entity.h>
...
//     {0x36D6, 0x53}, {0x36D7, 0x00}, {0x36D8, 0x71}, {0x36DA, 0x8C},
//     {0x36DB, 0x00}, {0x3701, 0x00}, {0x3720, 0x00}, {0x3724, 0x02},
//     {0x3726, 0x02}, {0x3732, 0x02}, {0x3734, 0x03}, {0x3736, 0x03},
//     {0x3742, 0x03}, {0x3862, 0xE0}, {0x38CC, 0x30}, {0x38CD, 0x2F},
//     {0x395C, 0x0C}, {0x39A4, 0x07}, {0x39A8, 0x32}, {0x39AA, 0x32},
//     {0x39AC, 0x32}, {0x39AE, 0x32}, {0x39B0, 0x32}, {0x39B2, 0x2F},
//     {0x39B4, 0x2D}, {0x39B6, 0x28}, {0x39B8, 0x30}, {0x39BA, 0x30},
//     {0x39BC, 0x30}, {0x39BE, 0x30}, {0x39C0, 0x30}, {0x39C2, 0x2E},
//     {0x39C4, 0x2B}, {0x39C6, 0x25}, {0x3A42, 0xD1}, {0x3A4C, 0x77},
//     {0x3AE0, 0x02}, {0x3AEC, 0x0C}, {0x3B00, 0x2E}, {0x3B06, 0x29},
//     {0x3B98, 0x25}, {0x3B99, 0x21}, {0x3B9B, 0x13}, {0x3B9C, 0x13},
//     {0x3B9D, 0x13}, {0x3B9E, 0x13}, {0x3BA1, 0x00}, {0x3BA2, 0x06},
//     {0x3BA3, 0x0B}, {0x3BA4, 0x10}, {0x3BA5, 0x14}, {0x3BA6, 0x18},
//     {0x3BA7, 0x1A}, {0x3BA8, 0x1A}, {0x3BA9, 0x1A}, {0x3BAC, 0xED},
//     {0x3BAD, 0x01}, {0x3BAE, 0xF6}, {0x3BAF, 0x02}, {0x3BB0, 0xA2},
//     {0x3BB1, 0x03}, {0x3BB2, 0xE0}, {0x3BB3, 0x03}, {0x3BB4, 0xE0},
//     {0x3BB5, 0x03}, {0x3BB6, 0xE0}, {0x3BB7, 0x03}, {0x3BB8, 0xE0},
//     {0x3BBA, 0xE0}, {0x3BBC, 0xDA}, {0x3BBE, 0x88}, {0x3BC0, 0x44},
//     {0x3BC2, 0x7B}, {0x3BC4, 0xA2}, {0x3BC8, 0xBD}, {0x3BCA, 0xBD},
//     {0x4001, 0x01}, {0x4004, 0x48}, {0x4005, 0x09}, {0x400c, 0x00},
//     {0x4018, 0xE7}, {0x401A, 0x37}, {0x401C, 0x37}, {0x401E, 0xf7},
//     {0x401F, 0x00}, {0x4020, 0x3f}, {0x4022, 0x6F}, {0x4023, 0x00},
//     {0x4024, 0x3f}, {0x4026, 0x5f}, {0x4028, 0x2F}, {0x4074, 0x1},
//     {0x3002, 0x00},
//     {REG_DELAY, 0x1E},
//     {REG_NULL, 0x00},
// };
...
//     const char *len_name;
//     u32         hdr_mode;   /* 当前HDR模式，默认0=NO_HDR */
// };
...
// /* ================================================================
//  * 新增：ioctl 实现，向 rkaiq 提供模块信息及HDR配置
//  * ================================================================ */
// static long myimx415_ioctl(struct v4l2_subdev *sd,
...
//         strlcpy(inf->base.lens, imx415->len_name,
//                 sizeof(inf->base.lens));
//         break;
//     }
//     case RKMODULE_GET_HDR_CFG: {
//         struct rkmodule_hdr_cfg *cfg = (struct rkmodule_hdr_cfg *)arg;
//         cfg->esp.mode = HDR_NORMAL_VC;
//         cfg->hdr_mode = imx415->hdr_mode;
//         break;
//     }
//     case RKMODULE_SET_HDR_CFG: {
//         struct rkmodule_hdr_cfg *cfg = (struct rkmodule_hdr_cfg *)arg;
//         /* 目前只支持 NO_HDR，记录下来即可 */
//         imx415->hdr_mode = cfg->hdr_mode;
//         break;
//     }
//     case RKMODULE_SET_QUICK_STREAM: {
//         /* rkaiq 会发这个命令，直接操作寄存器 */
//         u32 stream = *((u32 *)arg);
//         if (stream)
//             ret = myimx415_write_reg(imx415->client,
...
// #ifdef CONFIG_COMPAT
// static long myimx415_compat_ioctl32(struct v4l2_subdev *sd,
...
//             return -EFAULT;
//         ret = myimx415_ioctl(sd, cmd, &stream);
//         break;
//     default:
//         ret = -ENOIOCTLCMD;
//         break;
...
// /* ================================================================
//  * subdev ops：新增 core_ops 挂载 ioctl
//  * ================================================================ */
// static const struct v4l2_subdev_core_ops myimx415_core_ops = {
//     .ioctl          = myimx415_ioctl,
// #ifdef CONFIG_COMPAT
//     .compat_ioctl32 = myimx415_compat_ioctl32,
// #endif
// };
...
// static const struct v4l2_subdev_ops myimx415_subdev_ops = {
//     .core  = &myimx415_core_ops,   /* 新增 core_ops */
//     .video = &myimx415_video_ops,
//     .pad   = &myimx415_pad_ops,
// };
...
//     /* ----------------------------------------------------------------
//      * 新增：从设备树读取 rkaiq 所需模块信息
//      * 设备树里已有这四个属性，直接读取即可
//      * ---------------------------------------------------------------- */
//     ret = of_property_read_u32(dev->of_node,
//             "rockchip,camera-module-index", &imx415->module_index);
//     ret |= of_property_read_string(dev->of_node,
//             "rockchip,camera-module-facing", &imx415->module_facing);
//     ret |= of_property_read_string(dev->of_node,
//             "rockchip,camera-module-name", &imx415->module_name);
//     ret |= of_property_read_string(dev->of_node,
//             "rockchip,camera-module-lens-name", &imx415->len_name);
//     if (ret) {
...
// SPDX-License-Identifier: GPL-2.0
/*
 * my-imx415.c - learning IMX415 driver, adjusted closer to Rockchip original driver.
 *
 * 说明：
 * 1. 两个寄存器表 imx415_linear_10bit_3864x2192_891M_regs_2lane[] 和
 *    imx415_linear_10bit_1920x1080_891M_regs_2lane[] 请直接使用你当前驱动里的完整数组。
 * 2. 下面主体代码重点修正：power_on 顺序、mode 字段、pixel_rate、reserved[0]、
 *    RKMODULE ioctl、s_power、pinctrl、BRL 查询、subdev name。
 */
#include <linux/clk.h>
...
#define MIPI_FREQ_446M                  445500000
...
static const struct imx415_mode supported_modes_2lane[] = {
	{
		...
		.width = 3864,
		.height = 2192,
		.max_fps = { .numerator = 10000, .denominator = 150000 },
		.exp_def = 0x08ca - 0x08,
		.hts_def = 0x0898 * IMX415_2LANES * 2,
		.vts_def = 0x08ca,
		.mipi_freq_idx = 1,
...
static int myimx415_write_array(struct i2c_client *client, const struct regval *regs)
{
	...
	/* 对齐原始驱动：NULL 表不视为失败，2lane 的 global_reg_list 就是 NULL */
	if (!regs)
		return 0;
...
static int myimx415_read_reg(struct i2c_client *client, u16 reg,
...
static int myimx415_get_reso_dist(const struct imx415_mode *mode,
...
myimx415_find_best_fit(struct myimx415 *imx415, struct v4l2_subdev_format *fmt)
{
	...
	for (i = 0; i < imx415->cfg_num; i++) {
		dist = myimx415_get_reso_dist(&imx415->supported_modes[i], framefmt);
...
static void myimx415_change_mode(struct myimx415 *imx415,
					 const struct imx415_mode *mode)
{
	imx415->cur_mode = mode;
	imx415->cur_vts = mode->vts_def;
					     ...
					     struct v4l2_subdev_frame_size_enum *fse)
{
	...
	fse->min_width = fse->max_width = imx415->supported_modes[fse->index].width;
	fse->min_height = fse->max_height = imx415->supported_modes[fse->index].height;
	return 0;
}
				    ...
				    struct v4l2_subdev_format *fmt)
{
	...
	mode = myimx415_find_best_fit(imx415, fmt);
	fmt->format.code = mode->bus_fmt;
	fmt->format.width = mode->width;
	fmt->format.height = mode->height;
	fmt->format.field = V4L2_FIELD_NONE;
	...
	if (fmt->which == V4L2_SUBDEV_FORMAT_TRY) {
		...
		*v4l2_subdev_get_try_format(sd, cfg, fmt->pad) = fmt->format;
		...
		myimx415_change_mode(imx415, mode);
...
static int myimx415_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	if (ctrl->id == V4L2_CID_VBLANK && imx415->cur_mode->hdr_mode == NO_HDR) {
		vts = ctrl->val + imx415->cur_mode->height;
		__v4l2_ctrl_modify_range(imx415->exposure,
					 IMX415_EXPOSURE_MIN, vts - 8,
					 IMX415_EXPOSURE_STEP,
					 imx415->exposure->default_value);
	}
	...
	case V4L2_CID_EXPOSURE:
		...
		ret |= myimx415_write_reg(client, IMX415_LF_EXPO_REG_M,
						IMX415_REG_VALUE_08BIT, (shr0 >> 8) & 0xff);
		ret |= myimx415_write_reg(client, IMX415_LF_EXPO_REG_H,
						IMX415_REG_VALUE_08BIT, (shr0 >> 16) & 0x0f);
		break;
	case V4L2_CID_ANALOGUE_GAIN:
		if (imx415->cur_mode->hdr_mode != NO_HDR)
			break;
		ret = myimx415_write_reg(client, IMX415_LF_GAIN_REG_H,
					       IMX415_REG_VALUE_08BIT, (ctrl->val >> 8) & 0x07);
		ret |= myimx415_write_reg(client, IMX415_LF_GAIN_REG_L,
						IMX415_REG_VALUE_08BIT, ctrl->val & 0xff);
		break;
	case V4L2_CID_VBLANK:
		...
		ret |= myimx415_write_reg(client, IMX415_VTS_REG_M,
						IMX415_REG_VALUE_08BIT, (vts >> 8) & 0xff);
		ret |= myimx415_write_reg(client, IMX415_VTS_REG_H,
						IMX415_REG_VALUE_08BIT, (vts >> 16) & 0x0f);
		break;
	case V4L2_CID_HFLIP:
		ret = myimx415_read_reg(client, IMX415_FLIP_REG,
					      IMX415_REG_VALUE_08BIT, &val);
...
static int myimx415_initialize_controls(struct myimx415 *imx415)
{
	...
	pixel_rate = (u64)link_freq_items[mode->mipi_freq_idx] / mode->bpp *
		     2 * imx415->lanes;
	max_pixel_rate = (u64)MIPI_FREQ_1188M / mode->bpp * 2 * imx415->lanes;
	imx415->pixel_rate = v4l2_ctrl_new_std(handler, NULL,
				V4L2_CID_PIXEL_RATE, 0, max_pixel_rate, 1, pixel_rate);
	...
	imx415->exposure = v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops,
				V4L2_CID_EXPOSURE, IMX415_EXPOSURE_MIN,
				exposure_max, IMX415_EXPOSURE_STEP, mode->exp_def);

	imx415->anal_gain = v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops,
				V4L2_CID_ANALOGUE_GAIN, IMX415_GAIN_MIN,
				IMX415_GAIN_MAX, IMX415_GAIN_STEP, IMX415_GAIN_DEFAULT);

	v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops, V4L2_CID_HFLIP, 0, 1, 1, 0);
	v4l2_ctrl_new_std(handler, &myimx415_ctrl_ops, V4L2_CID_VFLIP, 0, 1, 1, 0);
...
static void myimx415_get_module_inf(struct myimx415 *imx415,
					    struct rkmodule_inf *inf)
{
	memset(inf, 0, sizeof(*inf));
	strlcpy(inf->base.sensor, IMX415_NAME, sizeof(inf->base.sensor));
	strlcpy(inf->base.module, imx415->module_name, sizeof(inf->base.module));
	strlcpy(inf->base.lens, imx415->len_name, sizeof(inf->base.lens));
}

static long myimx415_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	struct myimx415 *imx415 = to_myimx415(sd);
	struct rkmodule_hdr_cfg *hdr;
	u32 stream;
	...
	switch (cmd) {
	case RKMODULE_GET_MODULE_INFO:
		myimx415_get_module_inf(imx415, arg);
		break;
	case RKMODULE_GET_HDR_CFG:
		hdr = arg;
	...
	case RKMODULE_SET_HDR_CFG:
		...
		if (hdr->hdr_mode != imx415->cur_mode->hdr_mode) {
			dev_err(&imx415->client->dev,
				"not support hdr mode:%d for current simple driver\n",
				hdr->hdr_mode);
			ret = -EINVAL;
		}
		break;
	case RKMODULE_SET_QUICK_STREAM:
		stream = *((u32 *)arg);
		ret = myimx415_write_reg(imx415->client, IMX415_REG_CTRL_MODE,
					   IMX415_REG_VALUE_08BIT,
					   stream ? IMX415_MODE_STREAMING : IMX415_MODE_SW_STANDBY);
		break;
					    ...
					    unsigned int cmd, unsigned long arg)
{
	...
	case RKMODULE_SET_QUICK_STREAM:
		...
		break;
	case RKMODULE_GET_SONY_BRL:
		ret = myimx415_ioctl(sd, cmd, &brl);
		if (!ret && copy_to_user(up, &brl, sizeof(u32)))
			ret = -EFAULT;
		break;
	default:
		ret = -ENOIOCTLCMD;
...
static int __myimx415_start_stream(struct myimx415 *imx415)
{
	int ret;

	ret = myimx415_write_array(imx415->client, imx415->cur_mode->global_reg_list);
	if (ret)
		return ret;

	ret = myimx415_write_array(imx415->client, imx415->cur_mode->reg_list);
	if (ret)
		return ret;
	...
	return myimx415_write_reg(imx415->client, IMX415_REG_CTRL_MODE,
				      IMX415_REG_VALUE_08BIT, IMX415_MODE_STREAMING);
}

static int __myimx415_stop_stream(struct myimx415 *imx415)
{
	return myimx415_write_reg(imx415->client, IMX415_REG_CTRL_MODE,
				      IMX415_REG_VALUE_08BIT, IMX415_MODE_SW_STANDBY);
}
...
static int myimx415_s_stream(struct v4l2_subdev *sd, int on)
{
	...
	dev_info(&client->dev, "s_stream:%d %dx%d hdr:%d bpp:%d\n",
	...
	if (on) {
		...
		ret = __myimx415_start_stream(imx415);
		if (ret) {
			dev_err(&client->dev, "start stream failed: %d\n", ret);
			pm_runtime_put(&client->dev);
			goto unlock;
		}
	} else {
		__myimx415_stop_stream(imx415);
		pm_runtime_put(&client->dev);
	}
...
static int myimx415_s_power(struct v4l2_subdev *sd, int on)
{
	struct myimx415 *imx415 = to_myimx415(sd);
	struct i2c_client *client = imx415->client;
	int ret = 0;
...
static int myimx415_power_on(struct myimx415 *imx415)
{
	...
	/* 关键修改：先开 regulator，再拉 GPIO/CLK。不要像旧学习版那样最后才 enable regulator。 */
	ret = regulator_bulk_enable(IMX415_NUM_SUPPLIES, imx415->supplies);
	if (ret < 0) {
		dev_err(dev, "Failed to enable regulators\n");
		return ret;
	...
	if (clk_get_rate(imx415->xvclk) != imx415->cur_mode->xvclk)
		dev_warn(dev, "xvclk mismatched, get %lu expect %u\n",
			 clk_get_rate(imx415->xvclk), imx415->cur_mode->xvclk);
...
#ifdef CONFIG_VIDEO_V4L2_SUBDEV_API
static int myimx415_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	struct myimx415 *imx415 = to_myimx415(sd);
...
static const struct v4l2_subdev_internal_ops myimx415_internal_ops = {
	.open = myimx415_open,
};
#endif
...
static const struct dev_pm_ops myimx415_pm_ops = {
	SET_RUNTIME_PM_OPS(myimx415_runtime_suspend,
			   myimx415_runtime_resume, NULL)
};

static const struct v4l2_subdev_core_ops myimx415_core_ops = {
	.s_power = myimx415_s_power,
	.ioctl = myimx415_ioctl,
#ifdef CONFIG_COMPAT
	.compat_ioctl32 = myimx415_compat_ioctl32,
#endif
...
static const struct v4l2_subdev_ops myimx415_subdev_ops = {
	.core = &myimx415_core_ops,
	.video = &myimx415_video_ops,
	.pad = &myimx415_pad_ops,
};

static int myimx415_check_sensor_id(struct myimx415 *imx415)
{
	struct i2c_client *client = imx415->client;
	u32 id = 0;
	int ret;
	...
	ret = myimx415_read_reg(client, IMX415_REG_CHIP_ID,
				  IMX415_REG_VALUE_08BIT, &id);
	if (ret || id != CHIP_ID) {
		dev_err(&client->dev, "Unexpected sensor id 0x%02x, ret %d\n", id, ret);
		return -ENODEV;
	}

	dev_info(&client->dev, "Detected imx415 id 0x%02x\n", id);
	return 0;
}
				  ...
				  const struct i2c_device_id *id)
{
	...
	ret |= of_property_read_string(node, "rockchip,camera-module-name",
				      &imx415->module_name);
	ret |= of_property_read_string(node, "rockchip,camera-module-lens-name",
				      &imx415->len_name);
	if (ret) {
		dev_err(dev, "could not get module information!\n");
		return -EINVAL;
	...
	of_property_read_u32(node, DATA_LANES, &lanes);
	if (lanes != IMX415_2LANES) {
		dev_warn(dev, "this learning driver only supports 2 lanes, force 2 lanes\n");
		lanes = IMX415_2LANES;
	}
	imx415->lanes = lanes;
	...
	if (!IS_ERR(imx415->pinctrl)) {
		imx415->pins_default = pinctrl_lookup_state(imx415->pinctrl,
						OF_CAMERA_PINCTRL_STATE_DEFAULT);
		if (IS_ERR(imx415->pins_default))
			dev_info(dev, "could not get default pinstate\n");

		imx415->pins_sleep = pinctrl_lookup_state(imx415->pinctrl,
	...
	sd = &imx415->subdev;
	v4l2_i2c_subdev_init(sd, client, &myimx415_subdev_ops);
	...
	ret = myimx415_check_sensor_id(imx415);
	if (ret)
		goto err_power_off;

#ifdef CONFIG_VIDEO_V4L2_SUBDEV_API
	sd->internal_ops = &myimx415_internal_ops;
	...
	snprintf(sd->name, sizeof(sd->name), "m%02d_%s_%s %s",
		 imx415->module_index, facing, IMX415_NAME, dev_name(&client->dev));
	...
	dev_info(dev, "myimx415 probe success, lanes:%d mode:%dx%d\n",
		 imx415->lanes, imx415->cur_mode->width, imx415->cur_mode->height);
	return 0;
...
// #define IMX415_MAX_PIXEL_RATE		(MIPI_FREQ_891M / 10 * 2 * IMX415_2LANES)
// #define OF_CAMERA_HDR_MODE		"rockchip,camera-hdr-mode"
// #define DATA_LANES   			"rockchip,imx415-data-lanes"
