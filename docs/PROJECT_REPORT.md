...
> **口径：** 本文大量段落写于 1080p30 / 2 个 V4L2 buffer / 每 3 帧推理 / 约 71 ms 客户端口径时期。  
> **当前默认代码**见仓库根目录 [README.md](../README.md) 与分支 `latest-pending`：1080p60、4 DMA-BUF、`latest-pending` 每 4 帧拷贝、视频与 AI 双线程。文中 213 ms→71 ms、BUF_COUNT=2 等数字只作演进历史，不要当成当前实现。
